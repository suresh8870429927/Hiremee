...
public class Candidate_Driver_Class {
	...
	public void startReport(){
		...
		Regression_testing.config().setDocumentTitle("Hiremee_9.1_Web_Portal_UAT_candidate_module_Regression_Testing");
	...
	public void teardown() throws Exception
	{
		...
		email.setSubject("HireMee_9.1_Web_Portal_UAT_Candidate_Module_Regression_Testing_Extent_Report");
