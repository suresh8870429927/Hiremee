...
public class Assessment_Exam_College_Wise extends College_Driver_Class
{
	...
	public Assessment_Exam_College_Wise(WebDriver ldriver)
	{
		this.driver=ldriver;
	...
	{		
		...
		try
		{
			...
			Assessment_Exam_Username.sendKeys(Assessment_Admin_College.Hiremee_id);
			excel.Write_data_pass(7, 20, 12);
			//password=excel.Read_data(7, 21, 11);
			Assessment_Exam_Password.sendKeys(password_Exam);
